...
cmake .. -G "Visual Studio 14 2015 Win64" -DCMAKE_CONFIGURATION_TYPES=Release;Debug -DENABLE_GUI=ON -DLIBXML2_INCLUDE_DIR:PATH=D:/code/lib/rsa-3rd-party/default/include -DLIBXML2_LIBRARIES:PATH=D:/code/lib/rsa-3rd-party/default/lib && start devenv.exe DML.sln
